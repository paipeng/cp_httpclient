...
BmpWriter.prototype.writeToFile = function (imageFile) {
    fs.writeFileSync(imageFile, this.generateData());
}


BmpWriter.prototype.base64 = function () {
    var data = this.generateData();
    const b64Str = base64js.fromByteArray(data);
    return b64Str;
}
